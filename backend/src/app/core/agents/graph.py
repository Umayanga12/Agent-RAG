...
def create_qa_graph() -> Any:
    ...
    1. Planning Agent: analyzes question and generates search strategy
    2. Retrieval Agent: gathers context from vector store using plan
...
def run_qa_flow(question: str) -> Dict[str, Any]:
    ...
    Returns:
        ...
        - `sub_questions`: Decomposed sub-questions for targeted retrieval
    """
    graph = get_qa_graph()
